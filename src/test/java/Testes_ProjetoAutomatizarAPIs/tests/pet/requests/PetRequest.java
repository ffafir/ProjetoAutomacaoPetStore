package Testes_ProjetoAutomatizarAPIs.tests.pet.requests;

import Testes_ProjetoAutomatizarAPIs.payloads.PetPayload;
...
public class PetRequest {
    ...
    public Response register(int id, String nome, String status) {
        return given()
            ...
            .when()
                .body(PetPayload.toJsonComplete(id, nome, status))
                .post(PATH_PET);
    }
    ...
    public Response AlterarPetExistente(int id, String name, String status)
    {
        return given()
                .header("accept", "application/json")
                .header("Content-Type", "application/json")
                .when()
                .body(PetPayload.toJsonBasic(id, name, status))
                .put(PATH_PET);
    }
